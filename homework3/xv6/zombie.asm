...
strcmp(const char *p, const char *q)
{
  ...
  73:	90                   	nop    
  74:	8d 74 26 00          	lea    0x0(%esi),%esi
    p++, q++;
...
strchr(const char *s, char c)
{
 ...
 113:	90                   	nop    
 114:	8d 74 26 00          	lea    0x0(%esi),%esi
 ...
 120:	74 16                	je     138 <strchr+0x38>
    if(*s == c)
 122:	38 ca                	cmp    %cl,%dl
 124:	8d 74 26 00          	lea    0x0(%esi),%esi
 ...
 130:	c3                   	ret    
 131:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
}
...
printf(int fd, char *fmt, ...)
{
 ...
 3d3:	90                   	nop    
 3d4:	8d 74 26 00          	lea    0x0(%esi),%esi
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
 ...
 411:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
 ...
 431:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
 ...
 441:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
...
free(void *ap)
{
 ...
 614:	8d 74 26 00          	lea    0x0(%esi),%esi
 618:	72 1e                	jb     638 <free+0x48>
 61a:	39 d3                	cmp    %edx,%ebx
 61c:	8d 74 26 00          	lea    0x0(%esi),%esi
