...
int	sys_page_map_wopermcheck(envid_t src_env, void *src_pg,
		     envid_t dst_env, void *dst_pg, int perm);
...
// Lab 6:
int	sys_transmit_packet(char* packet, int pktsize);
int	sys_receive_packet(char* packet, int* size);
// Lab 6: Challenge
int	sys_map_receive_buffers(char* first_buffer);
int	sys_receive_packet_zerocopy(int* size);
