...
grep(char *pattern, int fd)
{
 ...
 1d3:	90                   	nop    
 1d4:	8d 74 26 00          	lea    0x0(%esi),%esi
    m += n;
    p = buf;
    while((q = strchr(p, '\n')) != 0){
      *q = 0;
...
strcpy(char *s, char *t)
{
 ...
 32c:	8d 74 26 00          	lea    0x0(%esi),%esi
  char *os;
...
strcmp(const char *p, const char *q)
{
 ...
 363:	90                   	nop    
 364:	8d 74 26 00          	lea    0x0(%esi),%esi
    p++, q++;
...
strchr(const char *s, char c)
{
 ...
 403:	90                   	nop    
 404:	8d 74 26 00          	lea    0x0(%esi),%esi
 ...
 420:	c3                   	ret    
 421:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
}
...
atoi(const char *s)
{
 ...
 453:	90                   	nop    
 454:	8d 74 26 00          	lea    0x0(%esi),%esi
    n = n*10 + *s++ - '0';
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 659:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
    putc(fd, buf[i]);
...
printf(int fd, char *fmt, ...)
{
 ...
 6c3:	90                   	nop    
 6c4:	8d 74 26 00          	lea    0x0(%esi),%esi
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
 ...
 731:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
 738:	0f 84 62 01 00 00    	je     8a0 <printf+0x200>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 73e:	83 fb 25             	cmp    $0x25,%ebx
 741:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
...
putc(int fd, char c)
{
 ...
 849:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
...
free(void *ap)
{
 ...
 904:	8d 74 26 00          	lea    0x0(%esi),%esi
 908:	72 1e                	jb     928 <free+0x48>
 90a:	39 d3                	cmp    %edx,%ebx
 90c:	8d 74 26 00          	lea    0x0(%esi),%esi
...
free(void *ap)
{
 ...
 91c:	8d 74 26 00          	lea    0x0(%esi),%esi
 ...
 979:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
malloc(uint nbytes)
{
 ...
 9b3:	90                   	nop    
 9b4:	8d 74 26 00          	lea    0x0(%esi),%esi
    }
    if(p == freep)
 ...
 9ea:	c3                   	ret    
 9eb:	90                   	nop    
 9ec:	8d 74 26 00          	lea    0x0(%esi),%esi
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
