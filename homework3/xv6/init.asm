...
strchr(const char *s, char c)
{
 ...
 210:	74 16                	je     228 <strchr+0x38>
    if(*s == c)
 212:	38 ca                	cmp    %cl,%dl
 214:	8d 74 26 00          	lea    0x0(%esi),%esi
 ...
 220:	c3                   	ret    
 221:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
}
...
atoi(const char *s)
{
 ...
 253:	90                   	nop    
 254:	8d 74 26 00          	lea    0x0(%esi),%esi
    n = n*10 + *s++ - '0';
...
printf(int fd, char *fmt, ...)
{
 ...
 4c3:	90                   	nop    
 4c4:	8d 74 26 00          	lea    0x0(%esi),%esi
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
 ...
 4f3:	90                   	nop    
 4f4:	8d 74 26 00          	lea    0x0(%esi),%esi
 ...
 541:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
...
putc(int fd, char c)
{
 ...
 649:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
...
malloc(uint nbytes)
{
 ...
 7b3:	90                   	nop    
 7b4:	8d 74 26 00          	lea    0x0(%esi),%esi
    }
    if(p == freep)
