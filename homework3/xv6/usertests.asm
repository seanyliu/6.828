      ...
      c0:	0f 84 7e 00 00 00    	je     144 <forktest+0xa4>
{
  ...
  for(; n > 0; n--){
      ...
      e4:	8d 74 26 00          	lea    0x0(%esi),%esi
...
bigdir(void)
{
  ...
  close(fd);
     ...
     691:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
  ...
  if(fd < 0){
    ...
    exit();
     ...
     789:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
createdelete(void)
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(i > 0 && (i % 2 ) == 0){
     ...
     7fb:	90                   	nop    
     7fc:	8d 74 26 00          	lea    0x0(%esi),%esi
     800:	0f 84 82 01 00 00    	je     988 <createdelete+0x1f8>
     806:	f6 c3 01             	test   $0x1,%bl
     809:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
  ...
  for(i = 0; i < N; i++){
     ...
     81c:	8d 74 26 00          	lea    0x0(%esi),%esi
  ...
  if(pid==0)
     ...
     824:	8d 74 26 00          	lea    0x0(%esi),%esi
  ...
  for(i = 0; i < N; i++){
    ...
    if((i == 0 || i >= N/2) && fd < 0){
     ...
     919:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
    }
    if(fd >= 0)
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     bc3:	5d                   	pop    %ebp
     bc4:	c3                   	ret    
     bc5:	8d 74 26 00          	lea    0x0(%esi),%esi
     bc9:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
dirfile(void)
{
  ...
  if(write(fd, "x", 1) > 0){
    ...
    exit();
     ...
     e09:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
...
bigfile(void)
{
  ...
  if(fd < 0){
     ...
     e59:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
    printf(1, "cannot create bigfile");
    exit();
  }
  for(i = 0; i < 20; i++){
  ...
  if(total != 20*600){
    ...
    1019:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
subdir(void)
{
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    115c:	8d 74 26 00          	lea    0x0(%esi),%esi
  }
  close(fd);
  ...
  if(chdir("dd/xx") == 0){
    ...
    17a9:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
concreate(void)
{
  ...
  file[2] = '\0';
    ...
    17dc:	8d 74 26 00          	lea    0x0(%esi),%esi
  for(i = 0; i < 40; i++){
    file[1] = '0' + i;
    unlink(file);
    pid = fork();
  ...
  fd = open(".", 0);
    ...
    18db:	90                   	nop    
    18dc:	8d 74 26 00          	lea    0x0(%esi),%esi
  n = 0;
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1903:	90                   	nop    
    1904:	8d 74 26 00          	lea    0x0(%esi),%esi
  ...
  if(n != 40){
    ...
    1953:	90                   	nop    
    1954:	8d 74 26 00          	lea    0x0(%esi),%esi
  ...
  for(i = 0; i < 40; i++){
    ...
    1979:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
  ...
  for(i = 0; i < 40; i++){
    ...
    19cc:	8d 74 26 00          	lea    0x0(%esi),%esi
    pid = fork();
    if(pid < 0){
      printf(1, "fork failed\n");
      exit();
  ...
  if(n != 40){
    ...
    1a99:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
unlinkread(void)
{
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1ed9:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
twofiles(void)
{
  ...
  fname = pid ? "f1" : "f2";
    ...
    201b:	90                   	nop    
    201c:	8d 74 26 00          	lea    0x0(%esi),%esi
    fd = open(i?"f1":"f2", 0);
    total = 0;
    while((n = read(fd, buf, sizeof(buf))) > 0){
      for(j = 0; j < n; j++){
    ...
    2129:	85 c0                	test   %eax,%eax
{
  ...
  if(pid == 0)
    ...
    22b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
    ...
    22f3:	85 c0                	test   %eax,%eax
{
  ...
  if(unlink("big") < 0) {
    ...
    24a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
    ...
    24e1:	85 c0                	test   %eax,%eax
{
  ...
  if(unlink("small") < 0) {
    ...
    26b9:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
mem(void)
{
  ...
  if((pid = fork()) == 0){
    ...
    2755:	8d 74 26 00          	lea    0x0(%esi),%esi
    2759:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
pipe1(void)
{
  ...
  if(pid == 0){
    ...
    2784:	8d 74 26 00          	lea    0x0(%esi),%esi
    ...
    27cb:	90                   	nop    
    27cc:	8d 74 26 00          	lea    0x0(%esi),%esi
      for(i = 0; i < n; i++){
  ...
  if(pid == 0){
    ...
    2864:	8d 74 26 00          	lea    0x0(%esi),%esi
    ...
    2873:	90                   	nop    
    2874:	8d 74 26 00          	lea    0x0(%esi),%esi
    ...
    28b6:	e9 4e ff ff ff       	jmp    2809 <pipe1+0xa9>
{
  ...
  if(pipe(fds) != 0){
    ...
    2909:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
    ...
    2932:	85 c0                	test   %eax,%eax
{
  ...
  pid2 = fork();
    ...
    2949:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
  if(pid2 == 0)
  ...
  printf(1, "preempt ok\n");
    ...
    2a79:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
main(int argc, char *argv[])
{
  ...
  writetest();
    ...
    2b4c:	8d 74 26 00          	lea    0x0(%esi),%esi
  writetest1();
...
strcpy(char *s, char *t)
{
    ...
    2c0c:	8d 74 26 00          	lea    0x0(%esi),%esi
  char *os;
  ...
  return os;
    ...
    2c29:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
strcmp(const char *p, const char *q)
{
  ...
  while(*p && *p == *q)
    ...
    2c43:	90                   	nop    
    2c44:	8d 74 26 00          	lea    0x0(%esi),%esi
    p++, q++;
...
strcmp(const char *p, const char *q)
{
  ...
  return (uchar)*p - (uchar)*q;
    ...
    2c67:	5d                   	pop    %ebp
    2c68:	c3                   	ret    
    2c69:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
}
...
strchr(const char *s, char c)
{
  ...
  for(; *s; s++)
    ...
    2ce3:	90                   	nop    
    2ce4:	8d 74 26 00          	lea    0x0(%esi),%esi
    ...
    2cf4:	8d 74 26 00          	lea    0x0(%esi),%esi
  ...
  return 0;
    ...
    2cfa:	5d                   	pop    %ebp
    2cfb:	90                   	nop    
    2cfc:	8d 74 26 00          	lea    0x0(%esi),%esi
    2d00:	c3                   	ret    
    2d01:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
}
...
strchr(const char *s, char c)
{
  ...
  return 0;
    ...
    2d0a:	5d                   	pop    %ebp
    2d0b:	90                   	nop    
    2d0c:	8d 74 26 00          	lea    0x0(%esi),%esi
    2d10:	c3                   	ret    
...
atoi(const char *s)
{
  ...
  while('0' <= *s && *s <= '9')
    ...
    2d33:	90                   	nop    
    2d34:	8d 74 26 00          	lea    0x0(%esi),%esi
    n = n*10 + *s++ - '0';
...
memmove(void *vdst, void *vsrc, int n)
{
  ...
  while(n-- > 0)
    ...
    2d74:	8d 74 26 00          	lea    0x0(%esi),%esi
    *dst++ = *src++;
    ...
    2d7f:	83 c2 01             	add    $0x1,%edx
{
  ...
  return vdst;
    ...
    2d8a:	5d                   	pop    %ebp
    2d8b:	c3                   	ret    
    2d8c:	8d 74 26 00          	lea    0x0(%esi),%esi
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  while(--i >= 0)
    ...
    2f39:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
    putc(fd, buf[i]);
...
printf(int fd, char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
    ...
    2fa3:	90                   	nop    
    2fa4:	8d 74 26 00          	lea    0x0(%esi),%esi
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3011:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
    3018:	0f 84 62 01 00 00    	je     3180 <printf+0x200>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    301e:	83 fb 25             	cmp    $0x25,%ebx
    3021:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    3129:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    31e4:	8d 74 26 00          	lea    0x0(%esi),%esi
    31e8:	72 1e                	jb     3208 <free+0x48>
    31ea:	39 d3                	cmp    %edx,%ebx
    31ec:	8d 74 26 00          	lea    0x0(%esi),%esi
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    31fc:	8d 74 26 00          	lea    0x0(%esi),%esi
  ...
  freep = p;
    ...
    3259:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
malloc(uint nbytes)
{
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3293:	90                   	nop    
    3294:	8d 74 26 00          	lea    0x0(%esi),%esi
    }
    if(p == freep)
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    32ca:	c3                   	ret    
    32cb:	90                   	nop    
    32cc:	8d 74 26 00          	lea    0x0(%esi),%esi
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
