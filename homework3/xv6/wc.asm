...
strchr(const char *s, char c)
{
 ...
 290:	74 16                	je     2a8 <strchr+0x38>
    if(*s == c)
 292:	38 ca                	cmp    %cl,%dl
 294:	8d 74 26 00          	lea    0x0(%esi),%esi
 ...
 2a0:	c3                   	ret    
 2a1:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
}
...
strchr(const char *s, char c)
{
 ...
 2aa:	5d                   	pop    %ebp
 2ab:	90                   	nop    
 2ac:	8d 74 26 00          	lea    0x0(%esi),%esi
 2b0:	c3                   	ret    
...
atoi(const char *s)
{
 ...
 2d3:	90                   	nop    
 2d4:	8d 74 26 00          	lea    0x0(%esi),%esi
    n = n*10 + *s++ - '0';
...
memmove(void *vdst, void *vsrc, int n)
{
 ...
 314:	8d 74 26 00          	lea    0x0(%esi),%esi
    *dst++ = *src++;
...
printf(int fd, char *fmt, ...)
{
 ...
 543:	90                   	nop    
 544:	8d 74 26 00          	lea    0x0(%esi),%esi
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
 ...
 5b1:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
 5b8:	0f 84 62 01 00 00    	je     720 <printf+0x200>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 5be:	83 fb 25             	cmp    $0x25,%ebx
 5c1:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
...
putc(int fd, char c)
{
 ...
 6c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
...
free(void *ap)
{
 ...
 784:	8d 74 26 00          	lea    0x0(%esi),%esi
...
free(void *ap)
{
 ...
 7f9:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
malloc(uint nbytes)
{
 ...
 833:	90                   	nop    
 834:	8d 74 26 00          	lea    0x0(%esi),%esi
    }
    if(p == freep)
