...
strcmp(const char *p, const char *q)
{
  ...
  c3:	90                   	nop    
  c4:	8d 74 26 00          	lea    0x0(%esi),%esi
    p++, q++;
...
strchr(const char *s, char c)
{
 ...
 180:	c3                   	ret    
 181:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
}
...
atoi(const char *s)
{
 ...
 1b3:	90                   	nop    
 1b4:	8d 74 26 00          	lea    0x0(%esi),%esi
    n = n*10 + *s++ - '0';
...
printf(int fd, char *fmt, ...)
{
 ...
 423:	90                   	nop    
 424:	8d 74 26 00          	lea    0x0(%esi),%esi
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
...
putc(int fd, char c)
{
 ...
 5a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
...
free(void *ap)
{
 ...
 664:	8d 74 26 00          	lea    0x0(%esi),%esi
...
free(void *ap)
{
 ...
 6d9:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
malloc(uint nbytes)
{
 ...
 713:	90                   	nop    
 714:	8d 74 26 00          	lea    0x0(%esi),%esi
    }
    if(p == freep)
