...
nulterminate(struct cmd *cmd)
{
  ...
  return cmd;
      ...
      62:	c3                   	ret    
      63:	90                   	nop    
      64:	8d 74 26 00          	lea    0x0(%esi),%esi
      *ecmd->eargv[i] = 0;
    break;
  ...
  return cmd;
      ...
      7f:	5d                   	pop    %ebp
      80:	c3                   	ret    
      81:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
    return 0;
  ...
  case EXEC:
    ...
    for(i=0; ecmd->argv[i]; i++)
      ...
      91:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
      *ecmd->eargv[i] = 0;
  ...
  *ps = s;
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     231:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
  while(s < es && strchr(whitespace, *s))
    s++;
  if(q)
    *q = s;
  ...
  case '>':
    ...
    if(*s == '>'){
     ...
     285:	8d 74 26 00          	lea    0x0(%esi),%esi
     ...
     49e:	89 7c 24 04          	mov    %edi,0x4(%esp)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    case '+':  // >>
     ...
     513:	90                   	nop    
     514:	8d 74 26 00          	lea    0x0(%esi),%esi
    tok = gettoken(ps, es, 0, 0);
    if(gettoken(ps, es, &q, &eq) != 'a')
      panic("missing file for redirection");
    switch(tok){
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
    panic("parseblock");
     ...
     889:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
     ...
     8bc:	89 5c 24 04          	mov    %ebx,0x4(%esp)
{
  ...
  return cmd;
     ...
     907:	5d                   	pop    %ebp
     908:	c3                   	ret    
     909:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
...
getcmd(char *buf, int nbuf)
{
  ...
  return 0;
     ...
     9a3:	5d                   	pop    %ebp
     9a4:	c3                   	ret    
     9a5:	8d 74 26 00          	lea    0x0(%esi),%esi
     9a9:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     a11:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
    wait();
    break;
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     ba4:	8d 74 26 00          	lea    0x0(%esi),%esi
...
main(void)
{
     ...
     bc1:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
  static char buf[100];
  int fd;
...
strcpy(char *s, char *t)
{
  ...
  return os;
     ...
     cc9:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
strcmp(const char *p, const char *q)
{
  ...
  while(*p && *p == *q)
     ...
     ce3:	90                   	nop    
     ce4:	8d 74 26 00          	lea    0x0(%esi),%esi
    p++, q++;
...
strchr(const char *s, char c)
{
  ...
  for(; *s; s++)
     ...
     d83:	90                   	nop    
     d84:	8d 74 26 00          	lea    0x0(%esi),%esi
    ...
    if(*s == c)
     d92:	38 ca                	cmp    %cl,%dl
     d94:	8d 74 26 00          	lea    0x0(%esi),%esi
  ...
  return 0;
     ...
     da0:	c3                   	ret    
     da1:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
}
...
strchr(const char *s, char c)
{
  ...
  return 0;
     ...
     daa:	5d                   	pop    %ebp
     dab:	90                   	nop    
     dac:	8d 74 26 00          	lea    0x0(%esi),%esi
     db0:	c3                   	ret    
...
atoi(const char *s)
{
  ...
  while('0' <= *s && *s <= '9')
     ...
     dd3:	90                   	nop    
     dd4:	8d 74 26 00          	lea    0x0(%esi),%esi
    n = n*10 + *s++ - '0';
...
memmove(void *vdst, void *vsrc, int n)
{
  ...
  while(n-- > 0)
     ...
     e14:	8d 74 26 00          	lea    0x0(%esi),%esi
    *dst++ = *src++;
     ...
     e1f:	83 c2 01             	add    $0x1,%edx
{
  ...
  return vdst;
     ...
     e2a:	5d                   	pop    %ebp
     e2b:	c3                   	ret    
     e2c:	8d 74 26 00          	lea    0x0(%esi),%esi
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  while(--i >= 0)
     ...
     fd9:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
    putc(fd, buf[i]);
...
printf(int fd, char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
    ...
    1043:	90                   	nop    
    1044:	8d 74 26 00          	lea    0x0(%esi),%esi
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
  ...
  for(i = 0; fmt[i]; i++){
    ...
    10b1:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
    10b8:	0f 84 62 01 00 00    	je     1220 <printf+0x200>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    10be:	83 fb 25             	cmp    $0x25,%ebx
    10c1:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    11c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1284:	8d 74 26 00          	lea    0x0(%esi),%esi
    1288:	72 1e                	jb     12a8 <free+0x48>
    128a:	39 d3                	cmp    %edx,%ebx
    128c:	8d 74 26 00          	lea    0x0(%esi),%esi
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    129c:	8d 74 26 00          	lea    0x0(%esi),%esi
...
malloc(uint nbytes)
{
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1333:	90                   	nop    
    1334:	8d 74 26 00          	lea    0x0(%esi),%esi
    }
    if(p == freep)
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    136a:	c3                   	ret    
    136b:	90                   	nop    
    136c:	8d 74 26 00          	lea    0x0(%esi),%esi
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
