...
ls(char *path)
{
 ...
 193:	90                   	nop    
 194:	8d 74 26 00          	lea    0x0(%esi),%esi
...
strcmp(const char *p, const char *q)
{
 ...
 3a3:	90                   	nop    
 3a4:	8d 74 26 00          	lea    0x0(%esi),%esi
    p++, q++;
...
memmove(void *vdst, void *vsrc, int n)
{
 ...
 4d4:	8d 74 26 00          	lea    0x0(%esi),%esi
    *dst++ = *src++;
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 699:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
    putc(fd, buf[i]);
...
printf(int fd, char *fmt, ...)
{
 ...
 733:	90                   	nop    
 734:	8d 74 26 00          	lea    0x0(%esi),%esi
 ...
 751:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
 758:	0f 84 b2 00 00 00    	je     810 <printf+0x130>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
 75e:	83 fb 73             	cmp    $0x73,%ebx
 761:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
 ...
 771:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
 778:	0f 84 62 01 00 00    	je     8e0 <printf+0x200>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 77e:	83 fb 25             	cmp    $0x25,%ebx
 781:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
...
free(void *ap)
{
 ...
 944:	8d 74 26 00          	lea    0x0(%esi),%esi
 948:	72 1e                	jb     968 <free+0x48>
 94a:	39 d3                	cmp    %edx,%ebx
 94c:	8d 74 26 00          	lea    0x0(%esi),%esi
...
free(void *ap)
{
 ...
 95c:	8d 74 26 00          	lea    0x0(%esi),%esi
 ...
 9b9:	8d bc 27 00 00 00 00 	lea    0x0(%edi),%edi
...
malloc(uint nbytes)
{
 ...
 9f3:	90                   	nop    
 9f4:	8d 74 26 00          	lea    0x0(%esi),%esi
    }
    if(p == freep)
 ...
 a2a:	c3                   	ret    
 a2b:	90                   	nop    
 a2c:	8d 74 26 00          	lea    0x0(%esi),%esi
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
