...
main(int argc, char *argv[])
{
  ...
  30:	c7 44 24 0c d0 07 00 	movl   $0x7d0,0xc(%esp)
  37:	00 
  38:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  3c:	83 c3 01             	add    $0x1,%ebx
  3f:	c7 44 24 04 d2 07 00 	movl   $0x7d2,0x4(%esp)
  46:	00 
  ...
  5b:	c7 44 24 0c d7 07 00 	movl   $0x7d7,0xc(%esp)
  62:	00 
  63:	8b 44 b7 fc          	mov    -0x4(%edi,%esi,4),%eax
  67:	c7 44 24 04 d2 07 00 	movl   $0x7d2,0x4(%esp)
  6e:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39e:	0f b6 82 e0 07 00 00 	movzbl 0x7e0(%edx),%eax
...
putc(int fd, char c)
{
 ...
 63b:	e9 05 fe ff ff       	jmp    445 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 640:	bb d9 07 00 00       	mov    $0x7d9,%ebx
...
free(void *ap)
{
 ...
 651:	8b 0d fc 07 00 00    	mov    0x7fc,%ecx
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6af:	89 19                	mov    %ebx,(%ecx)
  freep = p;
 6b1:	89 0d fc 07 00 00    	mov    %ecx,0x7fc
}
 6b7:	5b                   	pop    %ebx
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 ...
 6d9:	89 51 04             	mov    %edx,0x4(%ecx)
    ...
    p->s.ptr = bp;
  freep = p;
 6dc:	89 0d fc 07 00 00    	mov    %ecx,0x7fc
}
 6e2:	5b                   	pop    %ebx
 6e3:	5e                   	pop    %esi
 6e4:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 15 fc 07 00 00    	mov    0x7fc,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
malloc(uint nbytes)
{
 ...
 724:	8d 74 26 00          	lea    0x0(%esi),%esi
    ...
    if(p == freep)
 728:	3b 0d fc 07 00 00    	cmp    0x7fc,%ecx
 ...
 747:	89 59 04             	mov    %ebx,0x4(%ecx)
      ...
      freep = prevp;
 74a:	89 15 fc 07 00 00    	mov    %edx,0x7fc
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 792:	e8 b9 fe ff ff       	call   650 <free>
  return freep;
 797:	8b 15 fc 07 00 00    	mov    0x7fc,%edx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 7a5:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7a8:	c7 05 fc 07 00 00 f4 	movl   $0x7f4,0x7fc
 7af:	07 00 00 
    base.s.size = 0;
 7b2:	ba f4 07 00 00       	mov    $0x7f4,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7b7:	c7 05 f4 07 00 00 f4 	movl   $0x7f4,0x7f4
 7be:	07 00 00 
    base.s.size = 0;
 7c1:	c7 05 f8 07 00 00 00 	movl   $0x0,0x7f8
 7c8:	00 00 00 
